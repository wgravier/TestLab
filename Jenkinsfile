    ...
    stages {
        ...
        stage ('Deployment') {        
            steps {
                ...
                snDevOpsChange(ignoreErrors: false, changeRequestDetails:"""{setCloseCode:true,attributes:{"category":"DevOps", "priority":"1", "work_notes": "This Change will deploy the Lab-app"}}""")
